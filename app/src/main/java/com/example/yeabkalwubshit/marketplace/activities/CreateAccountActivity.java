...
import com.example.yeabkalwubshit.marketplace.tools.PasswordUtil;
...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set up the state selection spinner for the state codes.
    ...
    Address createAddress() {
        ...
        String city = mCity.getText().toString();
        String state = mState.getSelectedItem().toString();
        String country = getString(R.string.country_usa); /* Since zip codes are being used for the time being,
        country is automatically set to USA. Future work needed to expand functionality to any region. */
        String zip = mZip.getText().toString();
